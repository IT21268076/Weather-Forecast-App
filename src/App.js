...
function App() {
  ...
  return (
    ...
    // <div>
    //   <header>Weather Forecasting</header>
    //   <nav></nav>
    // <div className={`mx-auto max-w-screen-2xl mt-4 py-5 px-32 bg-gradient-to-br from-cyan-700 to-blue-700 h-fit shadow-xl shadow-gray-400 
    // ${formatBackground()}`}>
    ...
    //   <ToastContainer autoCloase={5000} theme='colored' newestOnTop={true}/>
    // </div>
    
    // </div>

    <div id='back' className='bg-gradient-to-r from-cyan-600 to-indigo-300'>
      <div class="topnav">
